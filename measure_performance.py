...
parser = argparse.ArgumentParser(description='Предсказание точности модели')
parser.add_argument('parameters', metavar = 'parameters', help='Назовите имя параметров файла, в котором были сохранены. Эти параметры будут использоваться для измерения точности.')
